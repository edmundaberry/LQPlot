...
systs = [ 0.127224775341, 0.142519011037]
...
for i_mass, mass in enumerate(masses) :
    for i_var, var in enumerate(vars):
        ...
        wjets_hist = bkgd_file.Get( "histo1D__WJet_Madgraph__"     + var  + "_LQ" + str(mass))
	ttbar_hist = bkgd_file.Get( "histo1D__TTbar_Madgraph__"    + var  + "_LQ" + str(mass))
	...
	leg.AddEntry(sig_hist  ,"LQ, M = "+str(mass)+" GeV, #beta = 0.5");
